 ...
 */
package id.ac.unpas.PERTEMUAN9;
...
public class AplikasiFileIO extends JFrame {
    ...
    private final JButton btnOpenText;
    private final JButton btnSaveText;
    private final JButton btnSaveBinary;
    private final JButton btnLoadBinary;
    private final JButton btnAppendText; // Latihan 4: Tambah tombol Append
